...
while True:
    ...
    for i in result:
        ...
        for j in i.boxes:
            ...
            width,height = x2-x1,y2-y2
            cvzone.cornerRect(image, (x1,y1,width,height))#,colorC=(220,100,21),colorR=(100,90,80)
            ...
            class_id = j.cls[0]
            print(class_id,"\n",j.cls)
            cvzone.putTextRect(image, f"{classes_names[int(class_id)]}:{confidence}",(max(0, x1), max(35, y1)))#,colorB=(90,90,12),thickness=3
